...
const PHASES = [
  { label: 'Pre-2020',    color: '#f97316', title: 'Migration & defence prominence',        body: 'Border/migration peaks in 2019 (~14% top-1). Military defence also elevated, partly driven by EP9 debates on PESCO and European Defence Fund.' },
  { label: '2020–2021',   color: '#0d9488', title: 'Pandemic-driven health securitisation',  body: 'Health security spikes to 5–6% of top-1 frames in 2020–21, driven entirely by COVID-19. Border/migration declines as the pandemic dominates the agenda.' },
  { label: '2022 onward', color: '#ef4444', title: 'War-driven military, energy & hybrid threats', body: "Russia's invasion produces sharp increases in military defence (12→19% by 2025) and energy security (8→15%). Foreign information interference grows steadily toward the 2024 EP elections." },
]
    ...
    <PT>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatCard value="78,041"    label="Paragraphs (avg 3.9/speech)"    color="text-amber-600"  delay={0.05} />
          <StatCard value="13"        label="Security frames"                color="text-emerald-600" delay={0.1} />
          <StatCard value="2019–2026" label="Period covered (EP9–10)"        color="text-purple-600" delay={0.15} />
        </div>
        ...
        <div>
          ...
          <h2 className="text-xl font-bold text-slate-900 mb-1">Three Phases of EP Security Discourse</h2>
          <p className="text-xs text-gray-500 mb-5">Overall pattern identified from the top-1 dominant frame time series, 2019–2026.</p>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-5">Based on top-1 dominant frame shares per year.</p>
          ...
          <p className="text-[11px] text-gray-400 mt-3 italic">
            Limitation: corpus covers EP9–10 (2019–2026) only. 2019 n=560 and 2020 n=368 are small due to partial-year coverage and COVID session disruptions.
          </p>
        </div>
        ...
        <div className="card p-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 text-xs text-gray-600">
            {[
              { label: 'Model', text: 'mDeBERTa-v3-mnli-xnli — zero-shot NLI classifier covering all 24 EU languages in a single checkpoint, enabling classification on source-language text without prior translation.' },
              { label: 'Unit of analysis', text: 'Paragraph (blank-line delimited per EP transcript, min. 450 characters). If a paragraph is below the threshold, it is merged with the next. Validated by robustness check against context-window units.' },
              { label: 'Threshold & multi-label', text: 'Confidence threshold = 0.4 (lower bound of the empirical score distribution). Frames are not mutually exclusive — 68% of paragraphs receive 2+ frame labels at threshold 0.5, consistent with securitisation theory.' },
              { label: 'Non-security category', text: 'Paragraphs below threshold for all security frames are assigned "Institutional / Procedural". 20% of paragraphs fall in this category, confirming the model captures substantive security framing.' },
              { label: 'Frame design', text: '13 frames derived from Buzan et al. (1998) five-sector framework, expanded using inductive BERTopic clusters (Step 2) and validated against EU security communication (ProtectEU COM(2025); Security Union COM(2020)605).' },
              { label: 'Corpus', text: '19,859 speeches pre-filtered for security language; 78,041 paragraphs. EP9–10 (July 2019 – early 2026). 24 EU languages; Maltese-dominated speeches excluded from the EN translation robustness check.' },
            ].map(({ label, text }) => (
              <div key={label}>
        ...
        <div>
          ...
          <div className="card p-5 mb-6 overflow-x-auto">
            ...
            <table className="w-full text-xs min-w-[600px]">
              <thead>
                <tr className="text-gray-400 text-[10px] uppercase tracking-wider border-b border-gray-200">
                  ...
                  <th className="text-center py-2 px-2 font-normal">ML vs EN<br /><span className="text-[9px] normal-case">multi-label</span></th>
                  <th className="text-center py-2 px-2 font-normal">Para vs Window<br /><span className="text-[9px] normal-case">multi-label</span></th>
                  <th className="text-center py-2 px-2 font-normal">ML vs EN<br /><span className="text-[9px] normal-case">top-1</span></th>
            ...
            <p className="text-[10px] text-gray-400 mt-3 italic leading-relaxed">
              Key finding: multi-label correlations are consistently higher than top-1. Top-1 for terrorism and military_defence shows low ML vs EN stability, indicating these frames are sensitive to linguistic nuance. Multi-label at paragraph level is the preferred and reported specification.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="card p-4">
              ...
              <img src="/ep-security-debates/robustness/robustness_top1_translation.png" alt="Top-1 ML vs EN robustness" className="w-full rounded" />
            </div>
            <div className="card p-4">
