      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <ChartCard
            ...
            description="Right-wing MEPs (EPP, ECR, PfE) produce the largest share of security discourse by volume. The Right orientation alone accounts for ~37% of all security-labelled paragraphs."
            animationDelay={0.25}
          >
            ...
            <p className="text-[10px] text-gray-400 mt-2 italic">Multi-label counts: a paragraph may be counted once per orientation group that produced it. Orientation based on EP political group membership.</p>
          </ChartCard>
        </div>
